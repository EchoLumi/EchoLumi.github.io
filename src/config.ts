...
export const siteConfig: SiteConfig = {
	title: "EchoLumi",
	subtitle: "Blog",
	siteURL: "https://EchoLumi.github.io//", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/EchoLumi",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/433159069?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/echocax",
					external: true,
					icon: "mdi:git",
				},
			],
